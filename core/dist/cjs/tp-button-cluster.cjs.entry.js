...
const TpButtonCluster = class {
    ...
    render() {
        ...
        if (loading) {
            ...
            content = index.h("div", { class: "tp-button-cluster__container", onClick: (event) => { this.toggle(event); } }, index.h("slot", { name: "expand-text" }), index.h("ion-icon", { class: "tp-button-cluster__icon", src: arrowIcon, "aria-hidden": "true" }), index.h("slot", { name: "collapse-text" }));
        }
