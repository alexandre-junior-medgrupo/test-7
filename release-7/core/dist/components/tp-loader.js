...
const TpLoader$1 = /*@__PURE__*/ proxyCustomElement(class TpLoader extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["tp-loader"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-loader":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpLoader$1);
            }
            break;
    } });
}

const TpLoader = TpLoader$1;
const defineCustomElement = defineCustomElement$1;

export { TpLoader, defineCustomElement };
