...
const TpLoader = class {
    ...
    render() {
        ...
        if (tpName === TpLoaderName.SECONDARY) {
            content = (index.h("div", null, index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null)));
        }
        else {
            content = (index.h("div", { class: "loader-container" }, index.h("svg", { viewBox: "0 0 100 100", xmlns: "http://www.w3.org/2000/svg" }, index.h("circle", { "tp-loader-circle": true, cx: "50", cy: "50", r: "47" }), index.h("polyline", { "tp-loader-polyline": true, points: "85,37 63,37 63,15 " }), index.h("polyline", { "tp-loader-polyline": true, points: "63,86 63,64 85,64 " }), index.h("polyline", { "tp-loader-polyline": true, points: "14,64 36,64 36,86 " }), index.h("polyline", { "tp-loader-polyline": true, points: "36,15 36,37 14,37 " }), index.h("line", { "tp-loader-line": true, x1: "45", y1: "40", x2: "45", y2: "15" }), index.h("line", { "tp-loader-line": true, x1: "54", y1: "40", x2: "54", y2: "15" }), index.h("line", { "tp-loader-line": true, x1: "60", y1: "46", x2: "85", y2: "46" }), index.h("line", { "tp-loader-line": true, x1: "60", y1: "55", x2: "85", y2: "55" }), index.h("line", { "tp-loader-line": true, x1: "54", y1: "61", x2: "54", y2: "86" }), index.h("line", { "tp-loader-line": true, x1: "45", y1: "61", x2: "45", y2: "86" }), index.h("line", { "tp-loader-line": true, x1: "39", y1: "55", x2: "14", y2: "55" }), index.h("line", { "tp-loader-line": true, x1: "39", y1: "46", x2: "14", y2: "46" }), index.h("rect", { "tp-loader-rect": true, x: "42", y: "43", width: "6", height: "6" }), index.h("rect", { "tp-loader-rect": true, x: "42", y: "52", width: "6", height: "6" }), index.h("rect", { "tp-loader-rect": true, x: "51", y: "43", width: "6", height: "6" }), index.h("rect", { "tp-loader-rect": true, x: "51", y: "52", width: "6", height: "6" }))));
        }
...
exports.tp_loader = TpLoader;

//# sourceMappingURL=tp-loader.cjs.entry.js.map