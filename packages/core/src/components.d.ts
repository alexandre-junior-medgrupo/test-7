...
declare global {
  interface HTMLTpChartBarElement
    extends Components.TpChartBar,
      HTMLStencilElement {}
  var HTMLTpChartBarElement: {
    prototype: HTMLTpChartBarElement;
    new (): HTMLTpChartBarElement;
  };
  interface HTMLTpComparisonChartBarElement
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      'tp-chart-bar': LocalJSX.TpChartBar &
        JSXBase.HTMLAttributes<HTMLTpChartBarElement>;
      'tp-comparison-chart-bar': LocalJSX.TpComparisonChartBar &
        JSXBase.HTMLAttributes<HTMLTpComparisonChartBarElement>;
